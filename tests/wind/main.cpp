...
BOOST_AUTO_TEST_CASE(test_mapGlfwActionToKeyAction_valid) {
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(GLFW_RELEASE) == wind::KEY_ACTIONS::RELEASED);
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(GLFW_PRESS) == wind::KEY_ACTIONS::PRESSED);
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(GLFW_REPEAT) == wind::KEY_ACTIONS::HELD);
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(GLFW_KEY_UNKNOWN) == wind::KEY_ACTIONS::RELEASED);
}

BOOST_AUTO_TEST_CASE(test_mapGlfwActionToKeyAction_invalid) {
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(-1) == wind::KEY_ACTIONS::RELEASED);
  BOOST_CHECK(wind::mapGlfwActionToKeyAction(100) == wind::KEY_ACTIONS::RELEASED);
}
